<?xml version="1.0" encoding="UTF-8"?>
	...
	<xsl:template match="/">
		...
		<div id="content">
			<h1>XML Sitemap</h1>
			<p class="expl">
				Generated by <a href="https://www.vanectro.com" target="_blank" rel="noopener noreferrer">Vanectro.Com</a> <a href="https://yoa.st/1y6" target="_blank" rel="noopener noreferrer">SEO</a>, this is an XML Sitemap, meant for consumption by search engines.<br/>
