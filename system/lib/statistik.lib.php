...
$sql_statistik      = "select * from statistik where date='$yesterday'";
$data_statistik     = $db->fetch($sql_statistik);
$result_statisktik  = $db->num_rows($sql_statistik);
if($result_statisktik > 0){
...
require_once(LIB.DS."browser.lib.php");
