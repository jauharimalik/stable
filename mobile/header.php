...
<?php 
	if(isset($_REQUEST["p"])){ 
		switch ($_GET["p"]) {		
			case "": require_once PLUG.DS."mobile/style.php"; break;
			...
			case "sewa": require_once PLUG.DS."mobile/style-sewa.php"; break;				
			...
			case "gallerydetail": require_once PLUG.DS."mobile/style-gallery.php"; break;
			default: require_once PLUG.DS."mobile/style2.php"; break;
		}
	} else {require_once PLUG.DS."mobile/style.php";}
?>
</head>
<body dir="ltr">
      <amp-font
	...
	<header itemscope="" itemtype="https://schema.org/WPHeader">
		...
		<a id="logo" href="https://m.plazafotocopy.com/"><amp-img src="https://m.plazafotocopy.com/assets/img/logo-plaza.svg" width="123" height="50"></amp-img></a>
	</header>
