...
$filtrnya1 = ("and (brand='canon') and (category like '%mesin fotocopy%') and (hot like '%baru%')  and (paket='') and (sewa='')");
...
<div class="halb hala">	
    ...
    <div class="container-fluid container-full">
				...
				<div id="meshSection1" class="meshSection">
					<div class="meshTitle">
						<div class="meshTitleVanectro"><b>HARGA MESIN FOTOCOPY CANON</b></div>
					</div>
