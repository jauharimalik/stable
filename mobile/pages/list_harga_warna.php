	<amp-accordion>
		<section expanded="">
			<h6 aria-expanded="true"><div class="pageHeader inline"><div class="new-product-title Mesin_Fotocopy_Paling_LARIS">Harga Mesin Fotocopy Warna <i class="fa fa-caret-down"></i></div></div></h6>	
			<div>
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12 margin-bottom-0">			
							...
							$a_nama_produk =str_replace(" + Meja","",$a_nama_produk);	
							$a_nama_produk =str_replace(" + DADF"," - DADF",$a_nama_produk);	
							
							$a_nama_produk =str_replace("C5035 | ","",$a_nama_produk);	
