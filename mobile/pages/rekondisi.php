...
$urutanya1 = ("harga_baru asc, harga_baru desc,  rekomendasi asc");
$filtrnya1 = ("and (category like '%mesin fotocopy%') and (hot like '%rekondisi%') and (paket='') and (sewa='') ");
...
<div class="halb hala">		
	<?php require_once "list_harga_rekondisi.php"; ?>
    <div class="container-fluid container-full">
				...
				<div id="meshSection1" class="meshSection">
					<div class="meshTitle">
						<div class="meshTitleVanectro"> MESIN FOTOCOPY MURAH <b>TAPI BUKAN MURAHAN</b></div>
					</div>
