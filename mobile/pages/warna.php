...
$urutanya1 = ("brand asc, harga_baru asc");
$filtrnya1 = ("and (category like '%mesin fotocopy warna%')  and (paket='') and (sewa='') ");
$filtrnya2 = ("(harga_baru>1000000)  and (paket='') and (sewa='') $filtrnya1");
$data_produk_catalog = ("select *  from produk where $filtrnya2 ORDER BY $urutanya1"); 
?>
<div class="container-fluid container-full pt51 hala">
<div class="halb hala">		
	<?php require_once "list_harga_warna.php"; ?>
    <div class="container-fluid container-full">	
				...
				<div id="meshSection1" class="meshSection">
					<div class="meshTitle">
						<div class="meshTitleVanectro">JUAL MESIN FOTOCOPY <b>WARNA A3 MURAH</b>!!</div>
					</div>
