...
$urutanya1 = ("harga_baru asc, rekomendasi desc,  hot asc ");
$filtrnya1 = ("and (brand='fuji xerox') and (category like '%mesin fotocopy%') and (hot like '%baru%')  and (paket='') and (sewa='')");
...
<div class="halb hala">	
	<?php require_once "list_harga_fujixerox.php"; ?>
    <div class="container-fluid container-full">
		...
		<div id="meshSection1" class="meshSection">
            <div class="meshTitle">
                <div class="meshTitleVanectro"><b>HARGA MESIN FOTOCOPY FUJI XEROX</b> !!</div>
            </div>
