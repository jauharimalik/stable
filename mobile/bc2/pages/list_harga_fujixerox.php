	<amp-accordion>
		<section expanded="">
			<h6 aria-expanded="true"><div class="pageHeader inline"><div class="new-product-title Mesin_Fotocopy_Paling_LARIS">Harga Mesin Fotocopy Fuji Xerox Baru <i class="fa fa-caret-down"></i></div></div></h6>	
			<div>
