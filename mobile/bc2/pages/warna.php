...
$filtrnya = ("(category='Mesin Fotocopy Warna')");
$data_produk = ("select * from produk where (harga_baru>1000000) AND  $filtrnya and (category='Mesin Fotocopy Warna') order by $urutanya");	
?>
...
<amp-selector role="tablist"
  ...
  <div role="tabpanel" class="tabContent">
    <div class="container-fluid container-full">
				<amp-carousel width="690" height="400" class="preview" layout="responsive" type="slides"delay="5000">			  
					<a href="">							  
					<amp-img srcset="<?php echo $c_cdn_img; ?>/mobile/banner/mesin-fotocopy-warna-fujixerox.jpg 1300w,<?php echo $c_cdn_img; ?>/mobile/banner/mesin-fotocopy-warna-fujixerox.jpg 1301w"
					         width="691"
					         height="400"
							 class="fotoslide"
					...
					<a href="">
					<amp-img srcset="<?php echo $c_cdn_img; ?>/mobile/banner/mesin-fotocopy-warna-banner.jpg 1300w, <?php echo $c_cdn_img; ?>/mobile/banner/mesin-fotocopy-warna-banner.jpg 1301w"
					         width="691"
					         height="400"
							 class="fotoslide"
					         layout="responsive"></amp-img>		
					...
					<a href="">
					<amp-img srcset="<?php echo $c_cdn_img; ?>/mobile/banner/mesin-fotocopy-warna-canon.jpg 1300w,<?php echo $c_cdn_img; ?>/mobile/banner/mesin-fotocopy-warna-canon.jpg 1301w"
					         width="691"
					         height="400"
							 class="fotoslide"
					         layout="responsive"></amp-img>		
	...
	<div class="pekat2 container-fluid container-full">	
		...
		<div class="margin-bottom-5"><div class="new-product-title Mesin_Fotocopy_Paling_LARIS">Cuci Gudang MESIN <span class="brush" > WARNA</span> !! </div>	</div>																	
  ...
  <div role="tab"
    class="tabButton"
    option="spoilerc"><i class="fa fa-bullhorn"></i> Info</div>
  <div role="tabpanel" class="tabContent">
    <div class="container-fluid container-full">	
				<amp-youtube width="480"
				  height="270"
				  layout="responsive"
				  data-videoid="rCaBzZlDsQY"
				  autoplay >
				</amp-youtube>					
				<!-- BONES-PRODUCT-GRID AND BONES-PRODUCT-LIST-ITEM STARTS -->	
				<div id="meshSection1" class="meshSection">
					<div class="meshTitle">
						<div class="meshTitleVanectro">GRATISS ONGKIR <b>SE-INDONESIA</b>!!</div>
					</div>
					<div class="meshDescription">
					Kebutuhan Pengadaan / Usaha untuk Wilayah Luar Jawa ?? Beli di <?php echo $site_name;?> Banyak Gratisan.
					<ul class="text-left">
						<li><b>PENGIRIMAN SAMPAI TUJUAN !!</b></li>
						<li><b>BIAYA TRAINING & INSTALASI !!</b></li>
						<li><b>BUKU MANUAL PENGGUNAAN !!</b></li>
						<li><b>TONER WARNA 1 SET !!</b></li>
					</ul></div>	
					<div class="space-2"></div>
					<center><a href="<?php echo $c_url;?>/pengiriman" class="button primary-bg light-color"><i class="fa fa-truck"></i> Lihat Harga Pengiriman Reguler </a></center>
					<div class="space-2"></div>
				</div>
	...
	<div class="tabcontent container-full">
		<div class="row">
			<div class="col-xs-1 spartan padding010">
				<amp-img
						srcset="<?php echo $c_cdn;?>/new/images/amp/hot.svg"
						width="46"
						height="46"
						layout="responsive"></amp-img>
			...
			<div class="col-xs-6 spartan">
				<h4 class="margin-bottom-0">MINTA PENAWARAN</h4>
				<p>Kemahalan?? Negoin Aja</p>
			</div>
			<div class="col-xs-2 spartan spartanbtn">
				<a href="<?php echo $c_url;?>/penawaran" class="button button-small  primary-bg light-color margin-left-0">Kesini Aja <i class="fa fa-caret-right icon-at-right"></i></a>
			</div><!-- COL-XS-6 ENDS -->
		</div><!-- ROW ENDS -->
	</div><!-- CONTAINER-FLUID ENDS -->		
	<div class="pekat container-fluid">		
		<div class="row">
			<div class="subkebutuhan col-xs-12">
				...
				<div class="apakahusaha">
					<div class="col-xs-3"> 
						<amp-img width="50" height="50" src="<?php echo $c_cdn;?>/new/images/amp/diskon-gede.svg" layout="responsive" alt="Unit Mesin Fotocopy Baru" ></amp-img>
					</div>
					<div class="col-xs-9 box-point"> 
						<h4 class="pointkeunggulan">Diskon Gede<br><small>Termurah se-Asia Tenggara</small></h4>
					</div>
				</div>	
				<div class="apakahusaha">					
					<div class="col-xs-3"> 
						<amp-img width="50" height="50" src="<?php echo $c_cdn;?>/new/images/amp/gratis-emas.svg" layout="responsive" alt="Unit Mesin Fotocopy Baru" ></amp-img>
					</div>
					<div class="col-xs-9 box-point"> 
						<h4 class="pointkeunggulan">Gratiss Logam Mulia<br><small>Beli Mesin Gratiss Emas 24K</small></h4>
					</div>						
				</div>	
			</div><!-- COL-XS-12 ENDS -->
		</div><!-- ROW ENDS -->	
...
<?php
$sql = "SELECT * FROM videos where (title like '%2020%' or title like '%warna%')order by videos.id desc";
$result = $db->query($sql);
...
<?php }} ?>					
	...
	<div class="tabcontent container-full">
		<div class="row pekat2">
			...
			<div class="col-xs-2 spartan spartanbtn">
				<a href="<?php echo $c_url;?>/tv/searchs/warna/" class="button button-small  primary-bg light-color margin-left-0">Kesini Aja <i class="fa fa-caret-right icon-at-right"></i></a>
			</div><!-- COL-XS-6 ENDS -->
		</div><!-- ROW ENDS -->
	</div><!-- CONTAINER-FLUID ENDS -->	
<?php $total_pelanggan = $db->num_rows("SELECT * FROM aktivitas_pelanggan order by tanggal desc"); $total_pelanggan= $total_pelanggan+1680; ?>	
		...
		<div class="row">
			<div class="col-xs-12">
				<amp-carousel class="blog-carousel" type="slides" autoplay delay="5500" layout="fixed-height" height=209>	
						<?php 	$data_produk = ("select *  from produk  LEFT JOIN aktivitas_pelanggan ON aktivitas_pelanggan.id_produk = produk.id_produk where produk.category='Mesin Fotocopy Warna' ORDER BY id DESC, tanggal DESC LIMIT 6"); ?>
						<?php
 ...
 <?php } ?>					
				...
				<amp-lightbox id="infopromo" class="dark-bg" layout="nodisplay" class="light">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<amp-lightbox id="infopengadaan" class="dark-bg" layout="nodisplay" class="light">
					<div class="lightbox " tabindex="0">
						<div class="middle modal-dialog putih">
							<div class="row modal-content">                        
								<div class="modal-body sidebar">
