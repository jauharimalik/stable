...
if (isset($_GET['q'])){
	...
	");
	if ($total_artikel == 0){ //jika kategorinya gak ada di db maka alihkan
	...
	if (isset($_GET['pg'])){
		...
		echo "
		<title>$c_title - search $q in page $page</title>
		<meta name='viewport' content='width=device-width, initial-scale=1.0'>
		<meta name='description' content='$c_title - search $q in page $page'>
		<meta name='keywords' content='$c_title - search $q in page $page, $c_title - page $page, view article in page $page'>
		";
	}
	else{
		echo "
		<title>$c_title - search $q</title>
		<meta name='viewport' content='width=device-width, initial-scale=1.0'>
		<meta name='description' content='$c_title - search $q'>
		<meta name='keywords' content='$c_title - search $q, $c_title'>
		";
		$page = 1;
	}
