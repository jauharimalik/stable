...
$filtrnya = ("(category like '%Mesin Fotocopy%') and (hot ='Rekondisi')");
$data_produk = ("select * from produk where (harga_baru>1000000) AND  $filtrnya and (category like '%Mesin Fotocopy%')  order by $urutanya");	
?>
...
<amp-selector role="tablist"
  ...
  <div role="tabpanel" class="tabContent">
    <div class="container-fluid container-full">
				<amp-carousel width="690" height="400" class="preview" layout="responsive" type="slides"delay="5000">			  
					<a href="">							  
					<amp-img srcset="<?php echo $c_cdn_img; ?>/mobile/banner/banner-rekondisi.jpg 1300w,<?php echo $c_cdn_img; ?>/mobile/banner/banner-rekondisi.jpg 1301w"
					         width="691"
					         height="400"
							 class="fotoslide"
					...
					<a href="">
					<amp-img srcset="<?php echo $c_cdn_img; ?>/mobile/banner/Rekondisi-2-min.jpg 1300w, <?php echo $c_cdn_img; ?>/mobile/banner/Rekondisi-2-min.jpg 1301w"
					         width="691"
					         height="400"
							 class="fotoslide"
					         layout="responsive"></amp-img>		
					...
					<a href="">
					<amp-img srcset="<?php echo $c_cdn_img; ?>/mobile/banner/Rekondisi-3-min.jpg 1300w,<?php echo $c_cdn_img; ?>/mobile/banner/Rekondisi-3-min.jpg 1301w"
					         width="691"
					         height="400"
							 class="fotoslide"
					         layout="responsive"></amp-img>		
	...
	<div class="pekat2 container-fluid container-full">	
		...
		<div class="margin-bottom-5"><div class="new-product-title Mesin_Fotocopy_Paling_LARIS">Mesin <span class="brush" >REKONDISI</span> <?php echo $nama_bln[date('m')]." - ".date('Y');?> !! </div>	</div>																	
  ...
  <div role="tabpanel" class="tabContent">
    <div class="container-fluid container-full">
				...
				<div class="text-center new-product-title Mesin_Fotocopy_Paling_LARIS">Mesin Fotocopy <span class="brush" >REKONDISI</span> di <?php echo ucwords($c_title);?>!! </div>
				...
				<div id="meshSection1" class="meshSection">
					<div class="meshTitle">
						<div class="meshTitleVanectro"> MESIN MURAH <b> TERMURAH SE-INDONESIA</b></div>
					</div>
					<div class="meshDescription">
					Mesin Fotocopy Murah Termurah Se-Asia Tenggara, Mesin Rekondisi 90% Kondisi Mesin Normal.
					<ul class="text-left">
						<li><b>GARANSI RESMI 1 TAHUN !!</b></li>
						<li><b>120.000++ TEKNISI DAERAH !!</b></li>
						<li><b>HARGA SPAREPART MURAH !!</b></li>
						<li><b>TERSEDIA SPAREPART ORI & KW !!</b></li>
					</ul></div>	
					<div class="space-2"></div>
					<center><a href="<?php echo $c_url;?>/penawaran" class="button primary-bg light-color"><i class="fa fa-gift"></i> Masih Dirasa Mahal Nego Aja!! </a></center>
					<div class="space-2"></div>
				</div>			
		...
		<div class="row">
			<div class="subkebutuhan col-xs-12">
				...
				<div class="apakahusaha">
					<div class="col-xs-3"> 
						<amp-img width="50" height="50" src="<?php echo $c_cdn;?>/new/images/amp/medal.svg" layout="responsive" alt="Unit Mesin Fotocopy Baru" ></amp-img>
					</div>
					<div class="col-xs-9 box-point"> 
						<h4 class="pointkeunggulan">Garansi 3 Tahun<br><small> Jaminan Mesin Awet</small></h4>
					</div>
				</div>	
				<div class="apakahusaha">
					<div class="col-xs-3"> 
						<amp-img width="50" height="50" src="<?php echo $c_cdn;?>/new/images/amp/wallet_2.svg" layout="responsive" alt="Unit Mesin Fotocopy Baru" ></amp-img>
					</div>
					<div class="col-xs-9 box-point"> 
						<h4 class="pointkeunggulan">Diskon Sampai 5 Jutaan<br><small>Termurah se-Asia Tenggara</small></h4>
					</div>
				</div>	
				<div class="apakahusaha">					
					<div class="col-xs-3"> 
						<amp-img width="50" height="50" src="<?php echo $c_cdn;?>/new/images/amp/world-wide.svg" layout="responsive" alt="Unit Mesin Fotocopy Baru" ></amp-img>
					</div>
					<div class="col-xs-9 box-point"> 
						<h4 class="pointkeunggulan">120.000++ Teknisi Daerah<br><small>Sampai Plosok Se-Indonesia</small></h4>
					</div>						
				</div>	
			</div><!-- COL-XS-12 ENDS -->
		</div><!-- ROW ENDS -->	
...
<?php
$sql = "SELECT * FROM videos where (title like '%canon ir%')order by videos.id desc";
$result = $db->query($sql);
...
<?php }} ?>					
	...
	<div class="tabcontent container-full">
		<div class="row pekat2">
			...
			<div class="col-xs-2 spartan spartanbtn">
				<a href="<?php echo $c_url;?>/tv/searchs/rekondisi/" class="button button-small  primary-bg light-color margin-left-0">Kesini Aja <i class="fa fa-caret-right icon-at-right"></i></a>
			</div><!-- COL-XS-6 ENDS -->
		</div><!-- ROW ENDS -->
	</div><!-- CONTAINER-FLUID ENDS -->	
		...
		<div class="row">
			<div class="col-xs-12">
				<amp-carousel class="blog-carousel" type="slides" autoplay delay="5500" layout="fixed-height" height=209>	
						<?php 	$data_produk = ("select *  from produk  LEFT JOIN aktivitas_pelanggan ON aktivitas_pelanggan.id_produk = produk.id_produk where produk.hot='Rekondisi' ORDER BY id DESC, tanggal DESC LIMIT 6"); ?>
						<?php
