...
.mobmenu{margin-bottom:10px;text-align:center}.mobmenu ul{padding:10px;list-style:none;width:100%}.mobmenu ul li{float:left;height:82px;width:calc((100% - 22px)/3);margin-bottom:13px;background:#fff;border-radius:6px;padding:0;box-shadow:0 2px 3px 0 rgba(0,0,0,.1);font-family:"Ubuntu",Arial;font-size:11px;color:#32325D}
.mobmenu ul li:not(:nth-child(3n)){margin-right:11px}.mobmenu ul li i{margin:5px;display:inline-block;font-size:30px}.mobmenu ul li span{display:block;color:#3e3e3e}
