...
switch ($_GET['act']) {
    ...
    case 'editberita':
                ...
                <div class='box'>
                    ...
                    <div class="box-body pad">
                        <form name="" action="../page/berita/proses.php?page=berita&act=updateberita" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <textarea name="isi" id="editor"><?php echo $d['isi_berita'];?></textarea>
								<script>initSample();</script> 
                           </div>
                            <div class="form-group">
                                <label class="col-md-12 control-label">Foto Produk</label>
                                <div class="col-md-12">
                                    <div class="thumbnail">
                                        <?php if(isset($d['gambar'])){?><img id="img_prev" src="<?php echo $c_cdn_img."/".$d['gambar'];?>" style="width:100%;height:auto;"/><?php } else {?>
										<img id="img_prev" src="<?php echo $c_cdn;?>/new/admin/img/nopreview.jpg" style="width:100%;height:auto;"/>
                                        <?php } ?><div class="caption">
                                            <span class="btn btn-default fileinput-button">
                                                <i class="glyphicon glyphicon-camera"></i>                              
                                                <input type="file" id="fileupload" name="gambar" value="<?php if(isset($d['gambar'])){echo $d['gambar'];}?>" onchange="readURL(this);" >
                                            </span>
                                        </div>
                                    </div>
                                </div>
        ...
        break;
	case 'komentar': 
	include CONTROL_MODULE.DS."komentar.php"; break;
    case 'hapusberita':
		//hapus foto 
