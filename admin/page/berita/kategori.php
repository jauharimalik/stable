                            ...
                            if ($cek_kategori != 0) {
                                while ($d = mysql_fetch_array($query)) {
                                    echo "<tr>
                                        ...
                                        <td align='center'>
                                            <a href='".$c_url."/admin/ws-kategoriberita/editkategori?id=$d[kategori_id]'>Edit</a> | 
                                            <a href='".$c_url."/admin/ws-kategoriberita/hapuskategori?id=$d[kategori_id]' onclick='return confirm(\"Apakah anda yakin akan menghapusnya?\");'>Hapus</a>
                                        </td></tr>";
                                    $no++;
                                }
                            } else {
