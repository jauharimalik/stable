            ...
            <section class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="media">
                            <div class="pull-left">
                                <img class="img-responsive media-object img-thumbnail" src="<?php echo $c_cdn;?>/uploads/users/<?php echo $d['avatar'];?>" style="width: 210px; height: auto;">
                            </div>
                            <div class="media-body">
                                <dl class="dl-horizontal">
                                    ...
                                    <dd>&nbsp;</dd>
                                    <dt>
                                    <form method="post" action="<?php echo $c_url;?>/admin/ws-profile/editprofile">
