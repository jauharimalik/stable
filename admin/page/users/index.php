                    ...
                    <div class="box-body">
                        <form name="userreg" method="post" action="../page/users/proses.php?page=users&act=submit" onsubmit="return cek_pass()" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">                                    
                                    <!--<img src="./../upload/users/<?php echo $c_cdn."/".$d['avatar'];?>" class="img-thumbnail img-responsive" style="width: auto; height: 255px;">-->
                                    <div class="thumbnail">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select name="level" class="form-control" required>
                                            ...
                                            <option value="Sales" <?php echo $d['level']=="Marketing" ? 'selected="selected"' : ''?>>Marketing</option>
											<option value="Sales" <?php echo $d['level']=="Teknisi" ? 'selected="selected"' : ''?>>Teknisi</option>
                                        </select>
                                    </div>
                                </div>   
                            <?php
                            } else { echo "<input type='hidden' name='level' value='".$d['level']."'>";}?>                            
                            <div class="form-group">
                                <label class="col-md-4 control-label">Foto Profile*</label>
                                <div class="col-md-4">
                                    ...
                                    <div class="thumbnail">
                                        <img id="img_prev" src="<?php echo $c_cdn;?>/uploads/users/<?php echo $d['avatar'];?>" style="width:100%;height:auto;"/>
                                        <div class="caption">
                                            <span class="btn btn-default fileinput-button">
                                                <i class="glyphicon glyphicon-camera"></i>                              
                                                <input type="file" id="fileupload" name="avatar" onchange="readURL(this);" >
                       ...
                       <table class="table table-bordered">
                            ...
                            while ($user = mysql_fetch_array($query_user)) {
                                echo "<tr>
                                    ...
                                    <td align='center'>
                                        <a href='".$c_url."/admin/ws-users/edituser?id=$user[user_id]'>Edit</a> | 
                                        <a href='../page/users/proses.php?page=users&act=hapususer&id=$user[user_id]&filename=$user[avatar]' onclick='return confirm(\"Apakah anda yakin akan menghapusnya?\");'>Hapus</a>
                                    </td></tr>";
                                $no++;
                            }
                            ?>                        
